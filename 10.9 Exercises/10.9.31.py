...
data1 = input("Enter a first data( mm/dd/yyyy) between 1901 - 2099 - ")
data2 = input("Enter a second data( mm/dd/yyyy) between 1901 - 2099 - ")
print()
...
if year_2 - year_1 == 0:
	...
	# if leap year			
		...
		if month_1 > 2 and month_2 > 2:
			days = (year[month_1 - 1] - day_1) + sum(year[(month_1 ):(month_2 - 1)])\
			+ day_2
