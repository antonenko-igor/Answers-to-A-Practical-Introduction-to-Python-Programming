...
print("For the next move, press Enter")
sign = ""
while player_1.hasCard() and player_2.hasCard():
	...
	if card1.value == card2.value:
		...
		sign = "<"
	print("player_1 -",card1, sign ,card2,"- player_2")
	print(f"The mumber of the cards : player_1 - {player_1.size()},\
	      player_2 - {player_2.size()}")
	input()
print("Game over.")
